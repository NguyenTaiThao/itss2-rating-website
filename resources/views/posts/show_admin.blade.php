    ...
    <div class="main-content">
        ...
        <div class="album py-5 bg-white">
            <div class="container">
                <div class="row mb-2">
                    <div class="col-12">
                        <a class="badge badge-primary" href="{{ url()->previous() }}"><i
                                class="fas fa-arrow-left mr-1"></i>前のページに戻る</a>
                        <a class="badge badge-primary" href="{{ route('home') }}"><i class="fas fa-home"></i></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6 d-flex flex-column justify-content-center">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6  d-flex align-items-center mt-3">
                                <input type="number" class="rating" min=0 max=5 data-size="lg"
                                    value={{ $post->rating_point }} readonly="true">
                            </div>
                            @if ($post->brand->id == auth()->user()->id)
                                <div class="col-6 d-flex align-items-center">
                                    <a href="{{ route('brand.post.edit', ['post' => $post->id]) }}"
                                        class="btn btn-warning mt-4">
                                        <i class="far fa-edit mr-1"></i>編集
                                    </a>
                                    <a href="{{ route('brand.post.delete', ['post' => $post->id]) }}"
                ...
                <div class="col-11 offset-1 mt-1 pl-0">
                    <form method="POST" action="{{ route('brand.comment.reply') }}">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="{{ $review->user->name }}のレビューへ返事する"
                                name="content">
