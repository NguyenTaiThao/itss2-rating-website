<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <!-- Brand -->
        <a class="navbar-brand pt-0" href="{{ route('brand.dashboard') }}">
            <img src="{{ asset('argon') }}/img/brand/icon_name.png" class="navbar-brand-img" alt="...">
        </a>
        <!-- User -->
        <ul class="nav align-items-center d-md-none">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                    ...
                    <a href="{{ route('brand.profile.edit') }}" class="dropdown-item">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#navbar-post-management" data-toggle="collapse" role="button"
                        aria-expanded="true" aria-controls="navbar-post-management">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#navbar-review-management" data-toggle="collapse" role="button"
                        aria-expanded="true" aria-controls="navbar-review-management">
